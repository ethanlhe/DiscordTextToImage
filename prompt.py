    ...
    def wait_until_position(self, interaction):
        ...
        while queue[0][0] != interaction:
            ...
            if temp_position != position:
                ...
                print("Queue position:", [param.description for param in interaction.command.parameters], position)
        print("Queue position:", [param.description for param in interaction.command.parameters], 1)
